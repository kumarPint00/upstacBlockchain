...
app.post("/:org/revokeUser", (req, res) => {
  revokeUser
    .execute(req.params.org, req.body.fabricUserName)
    .then(() => {
      const result = {
        status: "success",
...
app.post("/:org/updateTestDetails", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await updateTestDetails.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/getTestDetails", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await getTestDetails.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/getPatientTestDetails", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await getPatientTestDetails.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/requestPrice", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await requestPrice.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/getAllPriceRequests", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await getAllPriceRequests.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/getPriceRequest", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await getPriceRequest.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/approvePriceRequest", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await approvePriceRequest.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/getAllUsersData", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await getAllUsersData.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/getAllTestData", async (req, res) => {
  try {
    ...
    // Blockchain Request
    data = await getAllTestData.execute(
      org,
      fabricUserName,
      channelName,
      chainCodeName,
...
app.post("/:org/getTransactionById", async function (req, res) {
  try {
    ...
    // Get Data
    data = await getTransactionById.execute(
      org,
      fabricUserName,
      channelName,
      txId
...
app.listen(port, () =>
  console.log(`Distributed App listening on port ${port}!`)
);
